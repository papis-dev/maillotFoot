<?php  
     ...
     <div class="produit content-wrapper">
         <img src="imgs/<?=$produit['img']?>" width="1500" height="500" alt="<?=$produit['nom']?>">
         <div>
             ...
             <span class="price"> &dollar;<?=$produit['prix']?>
              ...
              <form action="index.php?page=panier" method="post">
                  ...
                  <input type="submit" value="Ajouter au panier">
                   ...
                   <?php if ($produit['id'] ==9): ?>
                   <button onclick="window.location.href = 'http://localhost/ProjetEvaluation/panier/PDF/maroc.php';">Télécharger</button>
                   <?php endif; ?>
                   <?php if ($produit['id'] ==13): ?>
                   <button onclick="window.location.href = 'http://localhost/ProjetEvaluation/panier/PDF/juventus.php';">Télécharger</button>
                   <?php endif; ?>
                   <?php if ($produit['id'] ==15): ?>
                   <button onclick="window.location.href = 'http://localhost/ProjetEvaluation/panier/PDF/united.php';">Télécharger</button>
                   <?php endif; ?>
                   <?php if ($produit['id'] ==11): ?>
                   <button onclick="window.location.href = 'http://localhost/ProjetEvaluation/panier/PDF/liverpool.php';">Télécharger</button>
                   <?php endif; ?>
