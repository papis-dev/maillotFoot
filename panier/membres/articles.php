            ...
            <div class="navigation d-flex">
                ...
                <div class="menu">
                    ...
                    <ul class="nav_list d-flex">
                        ...
                        <li class="nav-item">
                            <a href="boutique.html" class="nav-link">Utilisateurs</a>
                        </li>
                        <li class="nav-item">
                            <a href="http://localhost/ProjetEvaluation/panier/admin/utilisateurs.php" class="nav-link">Utilisateurs</a>
                        </li>
                        <li class="nav-item">
 ...
 <table>
   ...
   <?php
        ...
        if(mysqli_num_rows($result)>0)
        {
            ...
            {
                ?>
                <p><?php echo $row['mail'] ; ?><button onclick="window.location.href = 'bannir_membre.php?id=<?= $row['id']; ?>';">Supprimer</button></p><br><?php
            }
        }
    ?>
   </tbody>
